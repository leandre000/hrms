...
import { Menu, Search, Bell, User, Settings, LogOut, Plus, BookOpen, Video, Award } from 'lucide-react'
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-lg border border-gray-200 z-20">
                  <div className="p-4 border-b border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-900">Training Notifications</h3>
                  </div>
                      ...
                      >
                        <div className="flex items-start">
                          <div className={`w-2 h-2 rounded-full mt-2 mr-3 ${
                            ...
                            notification.type === 'action' ? 'bg-orange-500' :
                            notification.type === 'reminder' ? 'bg-purple-500' :
                            'bg-blue-500'
                          }`} />
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-1">
                              ...
                              <span className={`text-xs px-2 py-1 rounded-full ${
                                ...
                                notification.type === 'action' ? 'bg-orange-100 text-orange-800' :
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm font-medium text-gray-900">Training Manager</p>
                <p className="text-xs text-gray-500">Learning & Development</p>
              </div>
            </button>
